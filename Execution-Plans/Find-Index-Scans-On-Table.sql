...
from
	...
	left join sys.objects o on st.objectid = o.[object_id]
	left join sys.schemas sc on o.[schema_id] = sc.[schema_id]
where	qp.query_plan.exist('//RelOp[@PhysicalOp="Index Scan"]/OutputList/ColumnReference[@Schema=sql:variable("@SchemaName")][@Table=sql:variable("@TableName")]')=1
